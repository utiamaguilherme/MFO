...
Definition cabeca {X:Type} (l:list X) : option X :=
...
Fixpoint fold_l {X Y : Type} (f: Y->X->Y) (l: list X) (b: Y) : Y :=

  match l with
  | nil => b
  | h :: t => (fold_l f t (f b h))
  end.
